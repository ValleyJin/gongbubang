  ...
  return (
    <Card>
      ...
      <CardContent className="flex flex-col h-full min-h-[200px]">
        <ul className="space-y-1.5 sm:space-y-2 text-sm sm:text-sm list-disc list-inside leading-relaxed flex-grow">
          <li>
        ...
        <div className="mt-auto pt-3 sm:pt-4 p-2 sm:p-3 bg-orange-500/20 rounded text-sm sm:text-sm italic">
